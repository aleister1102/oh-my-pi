...
- Fixed Codex OAuth selection to keep chat and Spark quota ranking independent, preserve the uncapped-account priority signal when a secondary window is reported, and avoid treating incomplete usage reports as measured.
